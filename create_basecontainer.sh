...
docker exec -i racbase /bin/bash -c 'cp /root/prenetwork.sh /usr/local/bin/prenetwork.sh'
docker exec -i racbase /bin/bash -c 'chmod 0700 /usr/local/bin/prenetwork.sh'
