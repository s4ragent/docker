...
docker run --privileged=true -d -h node2.public --net=none --name node2 --dns=127.0.0.1 -v /lib/modules:/lib/modules test:racbase /sbin/init
sh ./docker_ip.sh node2 brvxlan0 eth0 192.168.0.102/24
sh ./docker_ip.sh node2 brvxlan1 eth1 192.168.100.102/24
sleep 35
